...
#     # executed
#     student_info = "C:/Users/scott/AppData/Local/tmc/vscode/mooc-programming-24/part06-06_course_grading_part_3/src/students1.csv"
#     exercise_data = "C:/Users/scott/AppData/Local/tmc/vscode/mooc-programming-24/part06-06_course_grading_part_3/src/exercises1.csv"
#     exam_points_info = 'C:/Users/scott/AppData/Local/tmc/vscode/mooc-programming-24/part06-06_course_grading_part_3/src/exam_points1.csv'
...
for index,student in enumerate(student_data):
    ...
    #print('pekka peloton                 21        5         9         14        0')
    print(f'{student_data[student][0]+' '+student_data[student][1]}{' '*(30-len(student_data[student][0]+' '+student_data[student][1]))}{sum_of_exercises}{(' '*(10-len(str(sum_of_exercises))))}{exercise_points}{(' '*(10-len(str(exercise_points))))}{student_exam_points}{(' '*(10-len(str(student_exam_points))))}{total}{(' '*(10-len(str(total))))}{grade}{(' '*(10-len(str(grade))))}')
